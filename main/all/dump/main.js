document.addEventListener('DOMContentLoaded', function () {
    ...
    registerLink.addEventListener('click', (e) => {
        ...
        registerForm.style.display = 'flex'; // Show the registration form
    });

    // Show the login form when "Login Now" is clicked
    ...
    const fragmentShaderSource = `
      ...
      void main() {
        ...
        for (float i = 0.0; i < 1.0; i++) {
          ...
          vec3 col = vec3(0.09, 0.02, 0.20) + // Use the color #090220
                     vec3(0.09, 0.02, 0.20) * cos(1.2 * (vec3(1.0) * (length(uv0) + i * 0.4 + iTime * 0.2) + vec3(0.263, 0.416, 0.557)));
